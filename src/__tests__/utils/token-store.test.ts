...
describe('Token Store', () => {
  ...
  describe('getToken', () => {
    it('should return token data when found', () => {
      ...
      // Act
      const result = tokenStore.getToken(userId);
    ...
    it('should handle errors and return null', () => {
      ...
      expect(logger.error).toHaveBeenCalledWith(
        expect.stringContaining(`Error getting token for user ${userId}`)
      );
    });
  });
  ...
  describe('storeToken', () => {
    it('should store token data with calculated TTL', () => {
      ...
      // Act
      const result = tokenStore.storeToken(userId, tokenData);
    ...
    it('should use undefined TTL when expiry is in the past', () => {
      ...
      expect(mockNodeCache.set).toHaveBeenCalledWith(
        userId,
        tokenData,
        undefined // TTL is undefined when expiry is in the past
      );
      expect(result).toBe(true);
    ...
    it('should handle errors and return false', () => {
      ...
      // Act
      const result = tokenStore.storeToken(userId, sampleTokenData);

      // Assert
      expect(mockNodeCache.set).toHaveBeenCalled();
      expect(result).toBe(false);
      expect(logger.error).toHaveBeenCalledWith(
        expect.stringContaining(`Error storing token for user ${userId}`)
      );
    });
  });
  ...
  describe('removeToken', () => {
    it('should return true when token is removed', () => {
      ...
      // Act
      const result = tokenStore.removeToken(userId);
    ...
    it('should handle errors and return false', () => {
      ...
      expect(result).toBe(false);
      expect(logger.error).toHaveBeenCalledWith(
        expect.stringContaining(`Error removing token for user ${userId}`)
      );
    });
  });
  ...
  describe('isTokenExpired', () => {
    it('should return true when token is expired', () => {
      ...
      // Act
      const result = tokenStore.isTokenExpired(userId);
    ...
    it('should handle errors and return true', () => {
      ...
      expect(result).toBe(true);
      expect(logger.error).toHaveBeenCalledWith(
        expect.stringContaining(`Error checking token expiry for user ${userId}`)
      );
    });
  });
  ...
  describe('calculateExpiryTime', () => {
    it('should calculate expiry time with default TTL', () => {
      ...
      // Act
      const result = tokenStore.calculateExpiryTime();
    ...
    it('should calculate expiry time with custom TTL', () => {
      ...
      // Act
      const result = tokenStore.calculateExpiryTime(customTtl);
  ...
  describe('getAllUserIds', () => {
    it('should return all user IDs', () => {
      ...
      // Act
      const result = tokenStore.getAllUserIds();
  ...
  describe('getStats', () => {
    it('should return cache statistics', () => {
      ...
      // Act
      const result = tokenStore.getStats();
